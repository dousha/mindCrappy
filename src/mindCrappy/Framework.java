...
public class Framework extends JFrame {
	...
	public framework frame = new framework(assets);
	...
	public class framework extends JPanel {
		...
		public framework(Assets as) {
			...
			bdpane.addChangeListener(new ChangeListener(){
				public void stateChanged(ChangeEvent e) {
					if(bdpane.getSelectedIndex() == 3){
		...
		public String fetchInfo() {
			...
			data.readSettings();
			builder = "<html><font color = white>\u7528\u6237\u540d:" + data.getUsername()
					+ "<br />" + "\u5185\u5b58\u5927\u5c0f:"
